...
qq.FileUploader = function(o){
	...
	qq.extend(this._options, {
		...
		template: '<div class="qq-uploader">' +
				...
				'<button class="qq-upload-button btn btn-default fileinput-upload fileinput-upload-button"><i class="glyphicon glyphicon-upload"></i>&nbsp;<span class="hidden-xs">{uploadButtonText}</span></button>' +
